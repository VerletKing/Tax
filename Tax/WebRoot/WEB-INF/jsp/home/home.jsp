        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，<s:property value="#session.SYS_USER.userName" />&nbsp;</font></a>
                    </td>
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;"><s:property value="#session.SYS_USER.userName"/></td>
                        </tr>
                        <tr>
        ...
        <div class="left_grzx1">
            ...
            <s:url var="infoViewUrl" action="home_infoViewUI" namespace="/sys">
            	<s:param name="info.infoId"><s:property value="infoId"/></s:param>
	                ...
	                <tr>
	                    <td height="23"><s:a href="%{#infoViewUrl}" target="_blank"><s:property value="title"/></s:a></td>
	                    <td width="150px"><s:property value="#infoType[type]"/></td>
    ...
    <div class="layout_center">
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <tr>
                    <td height="23"><s:a href="%{complainViewUrl}" target="_blank"><s:property value="compTitle"/></s:a></td>
                    <td width="180px"><s:property value="#complainState[state]"/></td>
