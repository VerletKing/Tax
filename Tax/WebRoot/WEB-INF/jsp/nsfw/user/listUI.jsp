...
<head>
    ...
    <script type="text/javascript">
		...
		//添加
		function doAdd(){
			document.forms[0].action="user_addUI.action"
			document.forms[0].submit();
		}
		
		//修改
		function doEdit(id){
			document.forms[0].action="user_editUI.action?user.id="+id;
			document.forms[0].submit();
		}
		
		//删除
		function doDelete(id){
			document.forms[0].action="user_delete.action?user.id="+id;
			document.forms[0].submit();
		}
		
		//批量删除
		function doDeleteAll(){
			document.forms[0].action="user_deleteSelected.action";
			document.forms[0].submit();
		}
		...
		var list_ui = "user_listUI.action";
		//搜索
		function doSearch(){
			$("pageNo").val(1);
                    ...
                    <table width="100%" border="0">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd">bgcolor="f8f8f8"</s:if> >  
                                ...
                                <td align="center"><s:property value="sex?'男':'女'"/></td>
